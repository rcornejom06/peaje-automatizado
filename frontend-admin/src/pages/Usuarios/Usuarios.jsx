  ...
  return (
    <div className="usuarios-page">
      <div className="usuarios-header">
        <div>
          <span className="page-tag">Administración</span>

          <h2>Gestión de Usuarios</h2>

          <p>
            Administra clientes, operadores y administradores del sistema.
          </p>
        </div>

        <button className="btn-refresh" onClick={cargarPerfiles}>
          <FiRefreshCw />
          Actualizar
        </button>
      </div>
