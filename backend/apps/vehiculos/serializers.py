...
class VehiculoSerializer(serializers.ModelSerializer):
    ...
    revisado_por_username = serializers.CharField(source="revisado_por.username",read_only=True)
    ...
    class Meta:
        model = Vehiculo
        fields = ["id","usuario","usuario_username","categoria","categoria_nombre","categoria_tarifa","placa","marca","modelo","color","anio","estado","fecha_registro","fecha_actualizacion","estado_revision","motivo_revision","fecha_revision","revisado_por","revisado_por_username","documento_respaldo","documento_respaldo_url",]
        read_only_fields = [
            "estado_revision",
            "motivo_revision",
            "fecha_revision",
